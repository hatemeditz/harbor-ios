...
A native SwiftUI Stremio client for iPhone — inspired by [Harbor](https://github.com/harborstremio/harbor), rebuilt from scratch for iOS. Sign in with your Stremio account, sync your library and addons, browse catalogs, rank streams, and play them.
...
4. Browse → tap a title → **Play** → pick a ranked stream
...
| Home rails from all your addon catalogs + Cinemeta | ✅ |
